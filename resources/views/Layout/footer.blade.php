              ...
              <ul class="d-flex flex-wrap gap g-2 py-2">
                <li>
                  <div class="media media-xxl">
                    <img src="{{asset('assets/images/product/a.jpg')}}" alt="" class="img-thumbnail">
                  </div>
                </li>
                <li>
                  <div class="media media-xxl">
                    <img src="{{asset('assets/images/product/b.jpg')}}" alt="" class="img-thumbnail">
                  </div>
                </li>
                <li>
                  <div class="media media-xxl">
                    <img src="{{asset('assets/images/product/c.jpg')}}" alt="" class="img-thumbnail">
                  </div>
                </li>
              </ul>
            </div>
              ...
              <div class="list-group-dotted mt-3">
                <div class="list-group-wrap">
                  <div class="p-3">
                    <div class="media-group">
                      <div class="media rounded-0">
                        <img src="{{asset('assets/images/icon/file-type-pdf.svg')}}" alt="">
                      </div>
                  ...
                  <div class="p-3">
                    <div class="media-group">
                      <div class="media rounded-0">
                        <img src="{{asset('assets/images/icon/file-type-doc.svg')}}" alt="">
                      </div>
                      <div class="media-text ms-1">
                  ...
                  <div class="p-3">
                    <div class="media-group">
                      <div class="media rounded-0">
                        <img src="{{asset('assets/images/icon/file-type-code.svg')}}" alt="">
                      </div>
                      <div class="media-text ms-1">
