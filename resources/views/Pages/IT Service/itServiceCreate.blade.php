                  ...
                  <div class="nk-block-head">
                    <div class="nk-block-head-between flex-wrap gap g-2">
                      <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Add IT Service </h1>
                          <nav>
                            <ol class="breadcrumb breadcrumb-arrow mb-0">
                              ...
                              <li class="breadcrumb-item">
                                <a href="{{route('it-sevice')}}">ecommerce</a>
                              </li>
                      ...
                      <div class="nk-block-head-content">
                        <ul class="d-flex">
                          <li>
                            <a href="{{route('it-sevice')}}" class="btn btn-primary btn-md d-md-none">
                              <em class="icon ni ni-eye"></em>
                              <span>View</span>
                            </a>
                          </li>
                          <li>
                            <a href="{{route('it-sevice')}}" class="btn btn-primary d-none d-md-inline-flex">
                              <em class="icon ni ni-eye"></em>
                                  ...
                                  <div class="row g-gs">
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="base_price" placeholder="Service price">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        <label for="tax-class" class="form-label">Tax Class</label>
                                        <div class="form-control-wrap">
                                          <select class="js-select" id="tax_class" data-search="true" data-sort="false">
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="vat-amount" placeholder="">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="sku" placeholder="SKU number">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="barcode" placeholder="Barcode number">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <div class="row g-gs">
                                          <div class="col-lg-12">
                                            <div class="form-control-wrap">
                                              <input type="number" id="quantity" class="form-control" placeholder="On shelf">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        <label for="tax-class" class="form-label">Availability</label>
                                        <div class="form-control-wrap">
                                          <select class="js-select" id="availability" data-search="true" data-sort="false">
                                            <option value="">Select an option</option>
                                    ...
                                    <div class="col-lg-12">
                                      <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                          <div class="js-quill" data-toolbar="minimal" data-placeholder="Write product description here..."></div>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-lg-12">
                                      <div class="form-group">
                                        <div class="form-check">
                                          <input class="form-check-input" type="checkbox" value="" id="addProductshippingCheckbox">
