                        ...
                        <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-none d-sm-block d-xl-none d-xxl-block me-md-5 me-xxl-0">
                              <img src="{{asset('assets/images/award/a.png')}}" alt="">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between align-items-end gap g-2">
                            <div class="flex-grow-1">
                              <div class="smaller">
                                <strong class="text-base">70%</strong> new activity <span class="d-block">this week.</span>
                              </div>
                              <div class="d-flex align-items-center mt-1">
                                <div class="amount h2 mb-0 fw-bold">89,720</div>
                                <div class="change up smaller ms-1">
                                  <em class="icon ni ni-trend-up"></em> 38
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="card h-100">
                            <div class="card-body">
                              ...
                              <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="change up smaller ms-1">
                                  <em class="icon ni ni-plus"></em> 12%
                                </div>
                              </div>
                          ...
                          <div class="card h-100">
                            <div class="card-body">
                              ...
                              <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="change up smaller ms-1">
                                  <em class="icon ni ni-plus"></em> 18%
                                </div>
                              </div>
                          ...
                          <div class="card h-100">
                            <div class="card-body">
                              ...
                              <div class="text-center">
                                <div class="nk-chart-ecommerce-knob js-pureknob" data-size="120" data-value="65" data-angle-offset="-0.5" data-angle-start="0.5" data-angle-end="0.5" data-color-fg="#0EA5E9"></div>
                            ...
                            <tbody>
                                ...
                                <td class="tb-col">
                                  <div class="media-group">
                                    <div class="media media-md flex-shrink-0 media-middle media-circle">
                                      <img src="{{asset('assets/images/product/a.jpg')}}" alt="">
                                    </div>
                              ...
                              <tr>
                                <td class="tb-col">
                                  <div class="media-group">
                                    <div class="media media-md flex-shrink-0 media-middle media-circle">
                                      <img src="{{asset('assets/images/product/b.jpg')}}" alt="">
                                    </div>
                                    <div class="media-text">
                              ...
                              <tr>
                                <td class="tb-col">
                                  <div class="media-group">
                                    <div class="media media-md flex-shrink-0 media-middle media-circle">
                                      <img src="{{asset('assets/images/product/d.jpg')}}" alt="">
                                    </div>
                                    <div class="media-text">
                              ...
                              <tr>
                                <td class="tb-col">
                                  <div class="media-group">
                                    <div class="media media-md flex-shrink-0 media-middle media-circle">
                                      <img src="{{asset('assets/images/product/e.jpg')}}" alt="">
                                    </div>
                                    <div class="media-text">
